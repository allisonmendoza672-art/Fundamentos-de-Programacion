...
print(f"Total de productos: {ien(carrito)}")
...
print(f"El de la posición 5 (úñtimo): {videojuegos[-1]}")
...
# Verificar si es una serie está en tu lista
...
# Ya viste la primera serie, lo eliminas
print(f"\n¡Terminaste de ver {series[0]}!")
series.pop(0)
print("Series restaurantes:", series)