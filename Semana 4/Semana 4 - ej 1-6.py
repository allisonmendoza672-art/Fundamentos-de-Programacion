...
while numero > 0:
    print(f"Faktan {numero} segundos...")
...
# Mientras el número sea menor 0 o igual a 50
while numero_pares <= 50:
    print(f"Número par: {numero_pares}")
    numero_pares = numero_pares + 2 # Incremeneamos de 2 en 2

    print("¡Todos los pares mostrados!\n")

print("\nEjercicio 6 - Dividir un número a la mitad")
# Inicializamos el número sea mayor o iguala 1
...
while contador <= 5
    ...
    contador = contador + 1 # Ahora sí incrementamos!
